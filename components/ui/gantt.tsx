...
import { formatDate, getDate, subDays } from 'date-fns';
...
export const GanttSidebarHeader: FC = () => (
    ...
    >
        ...
        <p className="flex-1 truncate text-left">Cards</p>
...
export const GanttSidebar: FC<GanttSidebarProps> = ({
    ...
    <div
        ...
        className={cn(
            'sticky left-0 z-30 shadow-lg h-max min-h-full overflow-clip border-border/50 border-r bg-background/90 backdrop-blur-md',
            className
        )}
    >
        <GanttSidebarHeader />
...
export const GanttToday: FC<GanttTodayProps> = ({ className, ...props }) => {
    const label = "Today"
    const date = new Date()
    const gantt = useContext(GanttContext)
    const differenceIn = getDifferenceIn(gantt.range)
