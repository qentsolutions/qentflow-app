    ...
    <div className="relative flex min-h-screen w-full h-full overflow-hidden bg-background">
      ...
      <div className="relative z-50 flex w-full flex-1 flex-col items-center justify-center p-6">
        <div className="w-full max-w-md pb-12 ">
          <h1 className="mb-2 text-3xl font-bold tracking-tight text-black md:text-4xl">Create an account</h1>
          <p className="text-gray-700">Join Qentflow to streamline your workflow</p>
          <RegisterForm />
        </div>
