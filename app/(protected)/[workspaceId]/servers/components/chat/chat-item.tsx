...
import { WorkspaceMember, UserRole, User } from "@prisma/client";
...
const roleIconMap = {
  "USER": null,
  "OWNER": <ShieldCheck className="h-4 w-4 ml-2 text-indigo-500" />,
...
export const ChatItem = ({
  ...
  const isModerator = currentMember.role === UserRole.OWNER;
