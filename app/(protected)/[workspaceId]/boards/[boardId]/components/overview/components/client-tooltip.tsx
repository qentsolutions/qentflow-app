...
const TooltipContent = React.forwardRef<HTMLDivElement, { children: React.ReactNode }>((props, forwardedRef) => {
    ...
    return createPortal(
        isMobile ? (
            <div
                className="fixed h-fit z-60 w-fit rounded-lg bg-background dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-3"
                style={{
            ...
            <div
                ref={tooltipRef}
                className="bg-background dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 px-3.5 py-2 rounded-sm fixed z-50"
